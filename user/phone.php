...
<head>
    ...
    <script>
      function phone(id,mg,ram){
        window.location.assign("phonesample.php?Id="+id +"&Col="+mg +"&Ram="+ram);
      }
    </script>
</head>
<body>
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
         <li><a href="home1.php" class="nav-link px-3 text-secondary">Home</a></li>
          ...
          <li><a  class="nav-link px-3 text-secondary">About</a></li>
        </ul>
    ...
    <div class="row container-fluid mt-5">
      ...
      while($row=$res->fetch_assoc())
      {
        $id=$row['Id'];
          ...
          $dis=$row['discribtion'];
          $qco="select * from productcolor join productram on productcolor.productId=productram.productId where productram.productId=$i";
          ...
          ?>
                <div class="card-body">
                    ...
                    <a  class="btn btn-primary" onclick="phone(<?php echo $id?>,<?php echo $colId?>,<?php echo $ram ?>)">Show More</a>
                </div>
              </div>
          </div>
      <?php
